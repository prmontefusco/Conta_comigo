...
export const DISCLAIMER_LEGAL_SUPERENDIVIDAMENTO =
  "AVISO LEGAL IMPORTANTE: O Conta Comigo é uma plataforma de organização contábil-financeira e planejamento orçamentário. Os cálculos, diagnósticos, planos de 60 meses e relatórios gerados têm finalidade exclusivamente instrutória e técnica para subsidiar o seu atendimento perante órgãos de defesa do consumidor (Procon, CEJUSC), Defensoria Pública ou advogado de sua confiança. O Conta Comigo NÃO presta serviços privativos de advocacia, NÃO ajuíza ações judiciais e NÃO garante a concessão de liminares, suspensão de descontos em folha ou homologação de propostas, decisões estas de competência soberana e exclusiva do Poder Judiciário brasileiro nos termos da legislação vigente.";
